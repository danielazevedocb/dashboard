...
export function Sidebar() {
  return (
    <div className="flex w-ful flex-col bg-muted/40">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  "
                >
                  <LogOut className="h-5 w5 text-red-500" />
